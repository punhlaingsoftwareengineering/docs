...
export function getAuthSessionOptions() {
	...
	const secureCookies = parseOptionalBooleanEnv(envString('AUTH_SESSION_SECURE_COOKIES'));
	const cookieDomain = envString('AUTH_COOKIE_DOMAIN');
