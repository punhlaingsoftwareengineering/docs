...
<div class="flex min-w-0 flex-1 flex-col space-y-8 p-6">
	...
	<section class="w-full min-w-0 space-y-4">
		...
		<form method="POST" action="?/updateSettings" use:enhance={formEnhance} class="flex w-full min-w-0 flex-col space-y-8">
			<AdminFormTable>
				<tr>
				...
				<tr>
					...
					<td class="min-w-0 p-0" colspan="3">
						...
						>
						<p class="mt-1 text-xs text-base-content/60">
							JSON array of <code>label</code> and <code>url</code> objects. Shown in the footer bar
							when social links are enabled.
						</p>
					</td>
				</tr>
				<tr>
		...
		<section class="w-full min-w-0 space-y-4">
			...
			<AdminFormTable>
				...
				<tr>
					<td class="align-top p-0 pt-3">
						<label class="label py-0" for="featuresItems"
							><span class="label-text">Feature cards</span></label
						>
					</td>
					<td class="min-w-0 p-0" colspan="3">
						<textarea
							...
							name="featuresItems"
							class="textarea textarea-bordered w-full font-mono text-sm"
							rows="14">{landing.featuresItems}</textarea
						>
						<p class="mt-1 text-xs text-base-content/60">
							JSON array of objects with title, description, badge, and href.
						</p>
					</td>
				</tr>
			</AdminFormTable>
		...
		<section class="w-full min-w-0 space-y-4">
			...
			<AdminFormTable>
				...
				<tr>
					<td class="align-middle p-0">
						<label class="label py-0" for="codePreviewTerminalLabel"
							><span class="label-text">Terminal label</span></label
						>
					</td>
					<td class="min-w-0 p-0" colspan="3">
						<input
							id="codePreviewTerminalLabel"
							name="codePreviewTerminalLabel"
							class="input input-bordered w-full"
							value={landing.codePreviewTerminalLabel}
						/>
					</td>
				</tr>
				<tr>
					<td class="align-top p-0 pt-3">
						<label class="label py-0" for="codePreviewLines"
							><span class="label-text">Terminal content</span></label
						>
					</td>
					<td class="min-w-0 p-0" colspan="3">
						<textarea
							id="codePreviewLines"
							name="codePreviewLines"
							class="textarea textarea-bordered w-full font-mono text-sm"
							rows="12">{landing.codePreviewLines}</textarea
						>
						<p class="mt-1 text-xs text-base-content/60">
							One line per row. Prefix a line with "$ " to show a shell prompt.
						</p>
					</td>
				</tr>
			</AdminFormTable>
		...
		<section class="w-full min-w-0 space-y-4">
			...
			<AdminFormTable>
				<tr>
					<td class="align-middle p-0">
						<label class="label py-0" for="docsCategoriesHeading"
							><span class="label-text">Section heading</span></label
						>
					</td>
					<td class="min-w-0 p-0" colspan="3">
						<input
							id="docsCategoriesHeading"
							name="docsCategoriesHeading"
							class="input input-bordered w-full"
							value={landing.docsCategoriesHeading}
						/>
					</td>
				</tr>
				<tr>
					<td class="align-top p-0 pt-3">
						<label class="label py-0" for="docsCategoriesSubtitle"
							><span class="label-text">Section subtitle</span></label
						>
					</td>
					<td class="min-w-0 p-0" colspan="3">
						<textarea
							id="docsCategoriesSubtitle"
							name="docsCategoriesSubtitle"
							class="textarea textarea-bordered w-full"
							rows="2">{landing.docsCategoriesSubtitle}</textarea
						>
					</td>
				</tr>
				<tr>
